...
export function LoadingScreen({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    ...
    // Show logo with delay for fade in effect
    ...
    <div className={`loading-screen ${isFadingOut ? 'fade-out' : ''}`}>
      ...
      <style jsx>{`
        ...
        .loading-screen.fade-out {
          animation: screenFadeOutCenter 1s ease-in-out forwards;
        }
        ...
        .logo-reveal-container {
          animation: logoFadeInDown 1.5s ease-out forwards;
        }
        ...
        .loading-logo {
          ...
          display: block;
          filter: drop-shadow(0 0 20px rgba(233, 225, 216, 0.5));
        }
        ...
        .loading-text {
          ...
          margin: 0;
          opacity: 0;
          animation: textFadeIn 0.8s ease-out 1s forwards, textGlow 2s ease-in-out 1.8s infinite alternate;
        }

        .loading-bar {
          width: 260px;
          height: 2px;
          background: rgba(233, 225, 216, 0.2);
          border-radius: 2px;
          overflow: hidden;
          margin: 2rem auto 0;
          opacity: 0;
          animation: barFadeIn 0.6s ease-out 1.2s forwards;
        }

        .loading-progress {
          height: 100%;
          background: linear-gradient(90deg, #E9E1D8 0%, rgba(233, 225, 216, 0.8) 100%);
          border-radius: 2px;
          transition: width 0.3s ease;
          box-shadow: 0 0 10px rgba(233, 225, 216, 0.6);
        }

        /* Fade out desde el centro */
        @keyframes screenFadeOutCenter {
          0% {
            opacity: 1;
            transform: scale(1);
          }
        ...
        /* Revelación del logo de arriba hacia abajo */
        ...
        /* Fade in del contenedor del logo */
        ...
        /* Fade in de la barra de progreso */
        @keyframes barFadeIn {
          0% {
            opacity: 0;
          }
        ...
        @keyframes textGlow {
          0% {
            text-shadow: 0 0 10px rgba(233, 225, 216, 0.3);
          }
          100% {
            text-shadow: 0 0 20px rgba(233, 225, 216, 0.8), 0 0 30px rgba(233, 225, 216, 0.4);
          }
        }
